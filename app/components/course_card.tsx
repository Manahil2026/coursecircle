...
const CourseCard: React.FC<CourseCardProps> = ({
  ...
  return (
    <div className="flex items-center border rounded-md p-2 shadow-lg bg-[#e7e7e9] w-full max-w-xl">
      ...
      <div className="ml-4 flex-1">
        ...
        <div className="mt-3 flex gap-2 text-sm">
          <button className="bg-[#B9FF66] px-4 py-1 rounded-lg ">Asgmt {assignmentsDue}</button>
          <button className="bg-[#B9FF66] px-4 py-1 rounded-lg ">Notifs {notifications}</button>
          <button className="bg-[#B9FF66] px-4 py-1 rounded-lg ">{schedule}</button>
        </div>
      </div>
    </div>
  );
